...
char ssid[] = "VIVO Y58 5G";   // your network SSID (name) 
char pass[] = "MUBARAKR123";   // your network password
int keyIndex = 0;            // your network key Index number (needed only for WEP)
WiFiClient  client;

unsigned long myChannelNumber = 3303250;
const int ChannelField = 1; 
const char * myWriteAPIKey = "501QI9BTC1WB2A0M";
...
![WhatsApp Image 2026-03-17 at 1 51 05 PM](https://github.com/user-attachments/assets/3b980d34-48bc-4137-8b30-1ead4564b3f6)

# OUTPUT:

<img width="1919" height="1079" alt="image" src="https://github.com/user-attachments/assets/c719d7f1-d8e6-409b-96c5-6a425b6dbee2" />


<img width="1919" height="1079" alt="image" src="https://github.com/user-attachments/assets/ff918c87-467f-49d8-b7c7-ec5e69978097" />
